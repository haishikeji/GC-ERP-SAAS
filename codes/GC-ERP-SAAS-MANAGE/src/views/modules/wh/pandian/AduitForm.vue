  ...
  <el-dialog
        ...
        <!-- <el-col :span="12">
         ...
         <el-col :span="12">
            <el-form-item label="盘点人" prop="pandianBy.id"
                ...
                <user-select :limit='1' :value="inputForm.pandianBy.id" @getValue='(value) => {inputForm.pandianBy.id=value}' :disabled="true"></user-select>
           </el-form-item>
        </el-col>
        <el-col :span="12">
    ...
    <el-col :span="24">
     <el-form-item label-width="0">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="审核意见" prop="status" :rules="[{required: true, message: '请选择审核意见', trigger: 'blur'}]">

              <el-radio v-model="inputForm.status" label="3" >通过</el-radio>
              <el-radio v-model="inputForm.status" label="4">不通过</el-radio>

          </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="审核备注" prop="aduitRemark" :rules="[]">
              <el-input type="textarea" v-model="inputForm.aduitRemark"  placeholder="请填写审核备注" ></el-input>
            </el-form-item>
          </el-col>
        </el-row>
    </el-form>
