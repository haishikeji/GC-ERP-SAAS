  ...
  <el-dialog
    ...
    <el-form :model="inputForm" size="small" ref="inputForm" v-loading="loading" :class="method==='view'?'readonly':''"  :disabled="method==='view'"
      ...
      <el-row  :gutter="15">
        ...
        <el-col :span="12">
            <el-form-item label="公司电话" prop="customCall"
                :rules="[
                 ]">
              <el-input v-model="inputForm.customCall" placeholder="请填写公司电话"     ></el-input>
           </el-form-item>
        </el-col>
        <el-col :span="12">
        ...
        <el-col :span="12">
            <el-form-item label="司机名称" prop="contactsName"
                :rules="[
                 ]">
              <el-input v-model="inputForm.contactsName" placeholder="请填写司机名称"     ></el-input>
           </el-form-item>
        </el-col>
        <el-col :span="12">
            <el-form-item label="司机手机" prop="contactsPhone"
                :rules="[
                 ]">
              <el-input v-model="inputForm.contactsPhone" placeholder="请填写司机手机"     ></el-input>
           </el-form-item>
        </el-col>
        <el-col :span="12">
