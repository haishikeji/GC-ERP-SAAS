  ...
  <el-dialog :title="title" :close-on-click-modal="false" v-dialogDrag :visible.sync="visible">
    <el-form size="small" :model="inputForm" ref="inputForm" :class="method==='view'?'readonly':''"
      ...
      <el-row :gutter="15">
        ...
        <el-col :span="12">
          <el-form-item label="最新采购价(元)" prop="newPurchasePrice" :rules="[
                 ]">
            <el-input v-model="inputForm.newPurchasePrice" placeholder="" :disabled="true"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="最高采购价(元)" prop="highPurchasePrice" :rules="[
                 ]">
            <el-input v-model="inputForm.highPurchasePrice" placeholder="" :disabled="true"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="最低采购价(元)" prop="lowerPurchasePrice" :rules="[
                 ]">
            <el-input v-model="inputForm.lowerPurchasePrice" placeholder="" :disabled="true"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="均价(元)" prop="lowerPurchasePrice" >
            <el-input v-model="inputForm.lowerPurchasePrice" placeholder="" :disabled="true"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="历史采购价1" prop="historyPurchasePrice1" >
            <el-input v-model="inputForm.historyPurchasePrice1" placeholder="" :disabled="true"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="历史采购价2" prop="historyPurchasePrice2" >
            <el-input v-model="inputForm.historyPurchasePrice2" placeholder="" :disabled="true"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="历史采购价3" prop="historyPurchasePrice3" >
            <el-input v-model="inputForm.historyPurchasePrice3" placeholder="" :disabled="true"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="历史采购价4" prop="historyPurchasePrice4" >
            <el-input v-model="inputForm.historyPurchasePrice4" placeholder="" :disabled="true"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="历史采购价5" prop="historyPurchasePrice5" >
            <el-input v-model="inputForm.historyPurchasePrice5" placeholder="" :disabled="true"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
  ...
  export default {
    data() {
      return {
        ...
        inputForm: {
          ...
          historyPurchasePrice1: '',
          historyPurchasePrice2: '',
          historyPurchasePrice3: '',
          historyPurchasePrice4: '',
          historyPurchasePrice5: '',
          remark:''
        }
      }
    },
    ...
    methods: {
      ...
      inventoryNameChange(data) {
        ...
        this.inputForm.newPurchasePrice = data[0].taxincludedPrice
      }
    }
  }
</script>
