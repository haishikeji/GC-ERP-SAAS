    ...
    <el-dialog :title="title" :close-on-click-modal="false" v-dialogDrag :visible.sync="visible">
      <el-form :model="inputForm" size="small" ref="inputForm" v-loading="loading"
        ...
        <el-row :gutter="15">
          ...
          <el-col :span="12">
            <el-form-item label="供应商等级" prop="supplierLevel" :rules="[
                 ]">
              <el-select id="measurementMethod" v-model="inputForm.supplierLevel" placeholder="请选择供应商等级"
                style="width: 100%;">
                <el-option v-for="item in $dictUtils.getDictList('supplier_level')" :key="item.value"
              ...
              <el-tabs v-model="supplierTab">
                <el-tab-pane label="供应商存货管理">
                  ...
                  <el-table class="table" size="small"
                    ...
                    <el-table-column prop="newPurchasePrice" header-align="center" align="center" show-overflow-tooltip
                      label="最新采购价(元)">
                    </el-table-column>
                    <el-table-column prop="highPurchasePrice" header-align="center" align="center" show-overflow-tooltip
                      label="最高采购价(元)">
                    </el-table-column>
                    <el-table-column prop="lowerPurchasePrice" header-align="center" align="center"
                      show-overflow-tooltip label="最低采购价(元)">
                    </el-table-column>
                    <el-table-column prop="averagePurchasePrice" header-align="center" align="center"
                      show-overflow-tooltip label="均价">
                    </el-table-column>
                    <el-table-column prop="historyPurchasePrice1" header-align="center" align="center"
                      show-overflow-tooltip label="历史采购价1">
                    </el-table-column>
                    <el-table-column prop="historyPurchasePrice2" header-align="center" align="center"
                      show-overflow-tooltip label="历史采购价2">
                    </el-table-column>
                    <el-table-column prop="historyPurchasePrice3" header-align="center" align="center"
                      show-overflow-tooltip label="历史采购价3">
                    </el-table-column>
                    <el-table-column prop="historyPurchasePrice4" header-align="center" align="center"
                      show-overflow-tooltip label="历史采购价4">
                    </el-table-column>
                    <el-table-column prop="historyPurchasePrice5" header-align="center" align="center"
                      show-overflow-tooltip label="历史采购价5">
                    </el-table-column>
