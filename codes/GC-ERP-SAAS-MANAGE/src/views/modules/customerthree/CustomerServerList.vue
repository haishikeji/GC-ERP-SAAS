      ...
      <div style="height: calc(100% - 80px);">
        <vxe-table border="inner" auto-resize resizable height="auto" :loading="loading" size="small"
          ...
          <vxe-column fixed="right" align="center" width="250" title="操作">
            <template slot-scope="scope">
              <el-button v-if="hasPermission('customer:customerServer:edit')" type="text" icon="el-icon-edit" size="small"
                @click="edit(scope.row.id)">分配人员</el-button>
...
export default {
  ...
  methods: {
    ...
    refreshList() {
      this.loading = true
      this.customerServerService.listTr({
